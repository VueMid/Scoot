<template>
    <section class="city">
        <div
            ...
            <img class="city__image rounded-[50%] w-max-[311px] md:w-[445px] target duration-[400ms]"
                src="@/assets/images/city.png" alt="city" v-motion-slide-visible-once-bottom>
            <div
                ...
                <p class="city__text w-max-[311px] text-dim-grey text-center text-[15px] font-normal leading-[25px] mt-8 md:w-[573px] md:mt-10 lg:w-[445px] lg:text-start lg:mt-6 dark:text-white/70 target duration-[400ms]"
                    v-motion-slide-visible-once-right>

    ...
    <section class="city pt-[120px] md:pt-[128px] lg:pt-[160px]">
        <div
            ...
            <div class="city__box flex flex-col justify-center items-center lg:flex-col lg:justify-center lg:items-start">
                <h3 class="city__title w-max-[314px] text-dark-navy text-center text-[32px] font-bold leading-8 mt-14 md:w-[471px] md:text-5xl md:leading-[48px] lg:w-[471px] lg:text-5xl lg:text-start lg:mt-0 dark:text-white target duration-[500ms]"

<template>
    <div id="staticModal" data-modal-backdrop="static" tabindex="-1" aria-hidden="true"
        class="easy__modal fixed top-0 left-0 right-0 z-[1111] w-full p-4 overflow-x-hidden overflow-y-auto h-full max-h-full bg-black/50 flex justify-center items-center lg:px-[0px]">
        <div
            ...
            <img class="easy__modal-image w-[211px] md:w-[445px] lg:ml-4" src="@/assets/images/guy__holding-phone.png"
                alt="">
            <div
                ...
                <TheButtonVue class="easy__modal-button" @click="$emit('closeModal')">I accept</TheButtonVue>
            </div>
        </div>
    </div>
</template>

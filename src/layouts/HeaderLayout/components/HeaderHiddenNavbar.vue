<template>
    <nav
        class="w-full h-[110vh] mt-[0px] pt-[134px] z-[999] pl-8 backdrop-blur-sm bg-white/80 dark:bg-tailwind-dark/90 fixed top-0 right-0 mx-auto flex justify-between items-start md:hidden md:backdrop-blur-none">
        <div class="">

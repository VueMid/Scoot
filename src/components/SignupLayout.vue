        ...
        <div
            ...
            <div class="signup__box-icons flex flex-row justify-center items-center gap-3">
                <a class="signup__icon cursor-pointer" target="_blank" href="https://www.apple.com/app-store/">
                    <img class="signup__images w-[114px] lg:w-[159px]" src="@/assets/icons/appstore.svg" alt="appstore">
                </a>
                <a class="signup__icon cursor-pointer" target="_blank" href="https://play.google.com/store/games">
                    <img class="signup__images w-[130px] lg:w-[182px]" src="@/assets/icons/googleplay.svg" alt="googleplay">
                </a>
            </div>
        </div>
    </section>
